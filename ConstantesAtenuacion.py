...
fig = plot.figure("Constantes de Atenuacion", figsize=(20,12), facecolor = 'white',edgecolor='blue')
...
plot.title(r'$Constantes$ $de$ $atenuacion$',fontsize = 24, color = 'black', verticalalignment = 'baseline', horizontalalignment = 'center')

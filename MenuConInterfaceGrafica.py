...
u = 1
fig = plot.figure("Menu de Seleccion", figsize=(13,2.5), facecolor = 'white',edgecolor='blue')
plot.figtext(0.5, 0.8, "Which Beam pattern do you want ?", style='italic', wrap=True, horizontalalignment='center', fontsize=18)
